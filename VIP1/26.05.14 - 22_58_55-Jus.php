...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.21 -- version
...
if lockPacket then return end  
 ...
 --if ValidTarget(Target) and dp:containsFloat(myPlayer.networkID) and dp:containsFloat(Target.networkID) then print(DumpPacket(p)) print("--------------------------------------") end
  ...
  dp:containsFloat(Target.networkID) and p.header == 0x64 and p.type == 12 then -- 0xFE --0x64 -- 0xC3
  --print('teste')
    CastQ(Target) 
  end
end
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            --print("AA")
          DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) then CastQ(Target) end end, spell.windUpTime + GetLatency()/2000) end
        ...
        if ComboON then
            ...
            DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) then myPlayer:Attack(Target) end end, spell.windUpTime + GetLatency()/2000) end
            --myPlayer:Attack(Target)
	        	qTick = GetTickCount() + GetLatency() / 2
