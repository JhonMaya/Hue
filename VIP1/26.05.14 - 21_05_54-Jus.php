...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.20 -- version
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            --print("AA")
            if ValidTarget(Target) and TargetIsValid(Target) then DelayAction(function() CastQ(Target) end, spell.windUpTime + GetLatency()/2000) end
        ...
        if ComboON then
            ...
            if ValidTarget(Target) and TargetIsValid(Target) then DelayAction(function() myPlayer:Attack(Target) end, spell.windUpTime + GetLatency()/2000) end
            --myPlayer:Attack(Target)
	        	qTick = GetTickCount() + GetLatency() / 2
