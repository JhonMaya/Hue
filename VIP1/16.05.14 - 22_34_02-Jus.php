...
local function CastQ(myTarget)   
    ...
    if useq then
        ...
        if GetDistance(myTarget) <= 550 and GetTickCount() + GetLatency() / 2 - qTick > del or GetTickCount() + GetLatency() / 2 - qTick > 3000 then -- (GetTickCount() + GetLatency() / 2) - qTick > del then                      
        ...
        -- if GetTickCount() + GetLatency() / 2 - qTick > 3000 then
        --     qTick = GetTickCount() + GetLatency() / 2
        --     CastSpell(_Q, myTarget.x, myTarget.z)
        -- end 
    end
