...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.28 -- version
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            --print("AA")
          DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) and menu.combo.key and not menu.farm.lasthit then CastQ(Target) end end, (qTick/2000 + spell.windUpTime - GetLatency()/2000))
        ...
        if ComboON then
            ...
            DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) and menu.combo.key and not menu.farm.lasthit then
                        ...
                        lastAttackCD/2000 + spell.windUpTime - GetLatency()/2000)
            --myPlayer:Attack(Target)
	        	qTick = GetTickCount() + GetLatency() / 2
