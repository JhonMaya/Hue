...
function OnCreateObj(obj)
	if obj.name == "DeathMark" then
		for i, enemy in ipairs(GetEnemyHeroes()) do
			if enemy and not enemy.dead and enemy.visible and GetDistance(enemy, obj) <= 75 then
				markedTarget = enemy
			end
		end
	end
...
function OnDeleteObj(obj)
	if obj.name == "DeathMark" then markedTarget = nil end
end
