...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.25 -- version
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            --print("AA")
          DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) and menu.combo.key or menu.extra.harass and not menu.farm.lasthit then CastQ(Target) end end, spell.windUpTime - GetLatency()/2000)
