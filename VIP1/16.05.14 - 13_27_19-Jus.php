...
function TextDamage(myTarget)
  ...
  if qDmg or wDmg or rDmg or iDmg ~= 0 then
    if qDmg >= myTarget.health then KillText = "3x(Q) can kill"
    elseif qDmg + wDmg >= myTarget.health then KillText = "(Q) + (W) can kill"  lockultimate = true
    elseif qDmg + rDmg >= myTarget.health then KillText = "(Q) + (R) can kill"  lockultimate = true
    ...
    elseif qDmg + wDmg + iDmg >= myTarget.health then KillText = "(Q) + (W) + (I)"  lockultimate = true
