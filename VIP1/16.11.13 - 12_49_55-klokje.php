...
class 'Prodict' -- { 
    ...
    function Prodict:GetPredictionOnImmobile(target, callback, activate, pStart)
        ...
        self.enemys[target.networkID]:GetPredictionOnImmobile(callback, source, activate)
    end 
    ...
    function Prodict:GetPredictionAfterImmobile(target, callback, activate, pStart)
        ...
        self.enemys[target.networkID]:GetPredictionAfterImmobile(callback, source, activate)
    end 
    ...
    function Prodict:GetPredictionOnDash(target, callback, activate, pStart)
        ...
        self.enemys[target.networkID]:GetProdictionOnDash(callback, source, activate)
    end 
    ...
    function Prodict:GetPredictionAfterDash(target, callback, activate, pStart)
        ...
        self.enemys[target.networkID]:GetPredictionAfterDash(callback, source, activate)
    end 
    ...
    function Prodict:EnableTarget(target, enable, from)
        if not self.onetime then
            self.onetime = true
            print("<font color='#36BBCE'>Prodict:EnableTarget will be delete next version of Prodiction. Ask dev to change it.</font>")
        end     
