...
if myHero.charName ~= "Corki" or not VIP_USER then return end
local version = "0.6"
...
local SpellR = {Range= 1225 ,Width = 40, Speed = 828, Delay=  -0.5}
...
Config.ComboSub.Rsub:addParam("Rhitchance", "R hitchance", SCRIPT_PARAM_SLICE, 2, 1, 2, 0)--((Harass))--
Config.HarassSub:addParam("ManaManager","Don't Harass if Mana is under %",SCRIPT_PARAM_SLICE,0,0,100)
...
if Config.HarassSub.ManaManager > (myHero.mana/myHero.maxMana) * 100 then return end 
...
KillSteal()
local Rfound = TS:GetTarget(SpellR.Range)
if Config.Ultimate.AimForme then R:Cast(Rfound) end
