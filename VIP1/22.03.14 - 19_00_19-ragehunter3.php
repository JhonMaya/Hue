...
UserContent = {"wukeokok", "Athena", "sevenjiang", "anheejun227", "killm0re", "andythesk8r", "ChrisSetzer", "anekraf", "lukeyboy89", "E7T", "birdpoodan", "quixor329", "tacD", "xPain", "Darkood", "geheim", "sovngarde", "pqmailer", "Gintoci", "Erwinbeck", "woddystory", "Dyrone", "blm95", "changster109", "Errinqq", "sehcure", "catbert", "asianone89", "thizz4win", "Supreme", "heel", "taka9999", "Shivan", "Melody", "Frosttfire", "xuzhe56828608", "kry0", "CLG Ahpromoo", "solenrus", "ddsq1226", "xtony211", "ejdernefesi", "ballsdeep", "iRes", "jsteez123", "kyk", "verajicus", "hhyyyyyh", "frinshy","Yeezus", "gianmaranon", "Phexon", "kpone53", "khicon", "Niekas", "tipanaya", "wildflower1", "WEEDZOR", "kihan112", "Cabana", "kelwynn", "justinchoy", "pyryoer", "ragehunter3", "Bugmenot1337", "Dobby", "Rileylol", "sirkouki", "pumadanny", "vipgogo4", "nakeshima", "48588484", "uronglance", "yt3063489", "792007467", "Akzification"}
local authed = false
...
function KS()
	for _, enemy in pairs(GetEnemyHeroes()) do
		if ValidTarget(enemy) then
					if myHero:CanUseSpell(_Q) == READY and getDmg("Q", enemy, myHero) > enemy.health and 					Menu.KS.KSQ then
					PrintFloatText(enemy, 0, "KS WITH Q")
					end
			if myHero:CanUseSpell(_Q) == READY and GetDistance(enemy) < qRange and getDmg("Q", enemy, myHero) > enemy.health and Menu.KS.KSQ then
				CastSpell(_Q, enemy)
				
									if myHero:CanUseSpell(_R) == READY and getDmg("R", enemy, myHero) > enemy.health and 					Menu.KS.KSR then
					PrintFloatText(enemy, 0, "KS WITH R")
					end
			elseif myHero:CanUseSpell(_R) == READY and GetDistance(enemy) < rRange and getDmg("R", enemy, myHero) > enemy.health and Menu.KS.KSR then
				CastSpell(_R, enemy.x, enemy.z)
							...
							if myHero:CanUseSpell(_E) == READY and getDmg("E", enemy, myHero) > enemy.health and 					Menu.KS.KSE then
					PrintFloatText(enemy, 0, "KS WITH E")
					end
