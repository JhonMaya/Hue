<?php exit() ?>--by bothappy 83.38.21.222
...
--[[Changelog:
	...
	v0.05:
		...
		+Added Laneclear
	v0.06:
		+Fixed attack on Laneclear
		+Better Callbacks (1 instead of 2)
		+2nd E usage on Combo
	]]
...
function CastQ(enemy)
	if ValidTarget(enemy) and (myHero:CanUseSpell(_Q) == READY) then
		MinHitChance = 2
