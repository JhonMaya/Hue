...
reticleDetectionRange = 1200  
   ...
   for i = 1, objManager.iCount, 1 do
        ...
        if obj ~= nil and string.find(obj.type, "obj_Turret") ~= nil and obj.health > 0 then
            if not string.find(obj.name, "TurretShrine") and obj.team ~= myHero.team then
...
function Plugin:__init()
    ...
    SkillR = AutoCarry.Skills:NewSkill(false, _R, 5000, "Whirling Death", AutoCarry.SPELL_LINEAR, 0, false, false, 1.80, 250, 120, false)
end
...
function doMovement()
	...
	disableAttacks = true
	if not InTurretRange(reticles[1]) then
