...
function DamageCombo(myTarget)
  ...
  elseif rDmg + qDmg >= myTarget.health then -- E -> Second R -> Q
    CastE(myTarget)
    if temUltimate then CastSecondR(myTarget) else CastSecondR(myTarget) end
    CastQ(myTarget)
  elseif tDmg + hDmg + rDmg + qDmg >= myTarget.health then -- E -> Hydra or Tiamat -> Second R -> Q
    CastE(myTarget)
    CastCommonItem(myTarget)
    if temUltimate then lockUltimate = false CastSecondR(myTarget) else NewCastR(myTarget) end
    CastQ(myTarget)
