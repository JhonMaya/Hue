<?php exit() ?>--by ragehunter3 141.101.99.243
if debug.getinfo(GetUser).linedefined > -1 then print("<font color='#FF0000'>Viktor: Denied</font>") return end
UserContent = {"xPain", "ragehunter3", "pqmailer", "Gintoci", "Erwinbeck", "woddystory", "Dyrone", "blm95", "changster109", "Errinqq", "sehcure", "catbert", "asianone89", "thizz4win", "Supreme", "heel", "taka9999", "Shivan", "Melody", "Frosttfire", "xuzhe56828608", "kry0", "CLG Ahpromoo", "Solenrus", "ddsq1226", "xtony211", "ejdernefesi", "ballsdeep", "iRes", "jsteez123", "kyk", "verajicus", "frinshy","Yeezus", "gianmaranon", "Phexon", "kpone53", "khicon", "Niekas", "tipanaya", "Sovngarde", "wildflower1", "weedzor", "kihan112", "Cabana", "kelwynn", "justinchoy"}
local authed = false
