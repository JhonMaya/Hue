...
function HandleR()
	if Target and ValidTarget(Target) and GetDistance(Target) <= 870 then
		if not HasUlt then
			CastSpell(_R, Target.x, Target.z)
			CastSpell(_E, Target.x, Target.z)
		end
...
function HandleRCast()
	...
	if Target and ValidTarget(Target) and GetDistance(Target) <= 850 then
...
function Killsteal()
 ...
 -- dmg calc stuff--
function SetActiveComboMode(ID)  -- is failing
...
function Plugin:OnDraw()
	DrawText((tostring(Target)) ,16,100, 100, 0xFF00FF00)
	DrawText((tostring(QDamageCG)) ,16,100, 120, 0xFF00FF00)
	DrawText((tostring(WDamageCG)) ,16,100, 140, 0xFF00FF00)
	DrawText((tostring(RDamageCG)) ,16,100, 180, 0xFF00FF00)
 if SACstate == 3 then return end
