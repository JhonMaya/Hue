...
--[[Beta Users, people who have paid for the script]]--
Beta =	 {
"tacD","biggin3","wukeokok", 
"hans_meier","solenrus","jta87k",
"Seamlessly","sunnr","herpaderpa123",
"straf","mewkyy","widelove","gianmaranon",
"web38","quixor329","Damnation", "kihan112",
"kobe2324", "ddsq1226","gee4hire","vinah",
"Phexon","ballsdeep","Rosenkrantz","Crackle",
"dansa", "johnnywalker", "darkdusk", "verajicus",
"araaj", "methodxb","ragekid","andythesk8r",
"ljk3322","khicon","xtony211","banned4haxx",
"xeph","Jae","kev","dragonne","63777377",
"tali0206","phebos","ejdernefesi","jiimmyp",
"phbn93","maxemz","klokje","empty1991",
"iodas1","kingkidd","Skito","kpone53","iJuno",
"Johay","Prasinos","Krippariam","theapemancometh",
"mrj","Diwas89","Darkood"
				}
local authed = false
...
--[[Pro Users, Just people I like or who have helped]]
UserContent = {"xPain", "HeX", "burn", "pqmailer", "kevinkev", "Astrostar", "Apple", "ragehunter3", "Trees", "Weee", "eddow", "3rasus"}
...
--if UserName == "solenrus" then print("Booooooooooooooooooooooooooooooooooobies - As requested. From Pain <3") end
function trueRange()
...
function OnLoad()
	...
	print("AIOSupport requires the use of 1.04 VPrediction (Untested with v1.05 if you have used 1.05 then please post on the forums).")
	VP = VPrediction()
	ExtraInfo = false
	README = false
