...
function Download()
  DownloadFile(UPDATE_URL, UPDATE_FILE_PATH, function () print("<font color=\"#FF0000\">DienoZac Download Finished, Please Double F9 after auth</font>") end)
end
if AUTOUPDATE then
...
-- _ENV[c({115,99,114,105,112,116,118,101,114})] = 0.03
...
function OnLoad()
  -- if GetUser() == 'BurningSchnitzel' or GetUser() == 'lucasrpc' or IsDDev() or GetUser() == 'teecolz' or OpenAccess == true then
  --     PrintChat("<font color='#FF0000'> Open Access Enabled Until v0.04!</font>")
  --     isAuthed = true
  ...
  PrintChat("<font color='#FF0000'> Zac Open Access Enabled Until v0.05!</font>")
  DelayAction(checkOrbwalker, 5)
  DelayAction(Menu, 5.5)
  DelayAction(Init, 5.5)
...
function OnGainBuff(unit, buff)
  if not isAuthed or not initDone then return end
...
function OnDraw()
  if not initDone or not isAuthed  then return end
