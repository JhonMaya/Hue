<?php exit() ?>--by ahmedzarga23 197.0.182.148
...
function AutoIgnite()
  local Gfound = TS:GetTarget(600)
	if Gfound then
	   if iReady and getDmg("IGNITE",Gfound, myHero) then CastSpell(ignite,Gfound) end
    end
  end
        ...
        if  BlockableProjectiles[spell.name].Blockable then 
          if BlockableProjectiles[spell.name].SpellType == "skillshot" then 
            ...
            if Hitchance >=1 then
              ...
              if not _G.Evadeee and W:IsReady() and Menu[spell.name]  then 
               CastSpell(_W,spell.startPos.x,spell.startPos.z)
              end 
              if _G.Evadeee then 
                if _G.Evadeee_impossibleToEvade and W:IsReady() and Menu[spell.name] then 
                  CastSpell(_W,spell.startPos.x,spell.startPos.z)
                end 
              end 
            end 
