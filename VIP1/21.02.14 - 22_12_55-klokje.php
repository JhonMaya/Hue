...
function _G.ProLoad(object, one, two)
	...
	local function Test()
	  ...
	  q, p = xpcall(function()  return string.dump(debug.getinfo) end, function(msg) print(msg) if string.find(msg, _A_'F?23=6 E@ 5F>A 8:G6? 7F?4E:@?') and string.find(msg, _A_'id`i') then  yy = yy + 1 end  end)
	  local h,g = xpcall(function() return string.dump(xpcall) end, function(msg) print(msg) if string.find(msg, _A_'F?23=6 E@ 5F>A 8:G6? 7F?4E:@?') and string.find(msg, _A_'idai') then yy = yy + 1 end  end)
