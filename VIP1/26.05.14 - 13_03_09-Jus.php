...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.18 -- version
        ...
        for i, Items_ in pairs(FoundItems) do
            if myTarget ~= nil then                            
                if GetDistance(myTarget) <= Items[Items_].range then
                    ...
                    elseif Items_ == "Yg" or Items_ == "SD" and TargetIsValid(myTarget) then
...
function DamageCombo(myTarget)
  ...
  elseif tDmg + hDmg + rDmg + qDmg >= myTarget.health then -- E -> Hydra or Tiamat -> Second R -> Q
    if myPlayer:CanUseSpell(_E) == READY then Packet('S_CAST', {spellId = SPELL_3, fromX = myPlayer.x, fromY = myPlayer.z, toX = myTarget.x, toY = myTarget.z}):send()  CastCommonItem(myTarget) end
