...
function OrbwalkDetection()
	if _G.AutoCarry
		then
			print("<font color=\"#FF794C\">[".._G.IsLoaded.."]:</font><font color=\"#FFDFBF\"> Sidas Auto Carry: Reborn (<b><font color=\"#cd57c5\">SAC:R</font></b>) detected! <font color=\"#6699ff\"><b>SOW</b></font> disabled!</font>")
			SAC = true
	...
	elseif _G.MMA_Loaded 
		then
			print("<font color=\"#FF794C\">[".._G.IsLoaded.."]:</font><font color=\"#FFDFBF\"> Marksman's Mighty Assistant (<b><font color=\"#FFFF00\">MMA</font></b>)detected! <font color=\"#6699ff\"><b>SOW</b></font> disabled!</font>")
			MMA = true
			rSOW.Menu.Enabled = false
	else
			print("<font color=\"#FF794C\">[".._G.IsLoaded.."]:</font><font color=\"#FFDFBF\"> No other Orbwalker detected! Using Simple Orbwalker (<b><font color=\"#6699ff\">SOW</font></b>)!</font>")
...
function KeyBindings()
	...
	if MMA
		then 
			if _G.MMA_LaneClear then JungleClear() LaneClear() end
			if _G.MMA_HybridMode then Harass() end
			if _G.MMA_Orbwalker then SBTW() end
	end
end
