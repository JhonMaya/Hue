<?php exit() ?>--by ahmedzarga23 41.226.115.61
--If you are Encrypting start from here--
...
function Combo()
  ...
  if itarget then
    ...
    if RDQ == true then
      if QEfound and  Q:IsReady() and Config.ComboSub.ComboSub1.useQ and not Config.ComboSub.Packet.useP and (not isCastingE or (isCastingE and TS:GetTarget(350))) then
        Q:Cast(QEfound)
        elseif QEfound and  Q:IsReady() and Config.ComboSub.ComboSub1.useQ and  Config.ComboSub.Packet.useP and (not isCastingE or (isCastingE and TS:GetTarget(350))) then
        CastQPacket(QEfound)
        end
    end
...
function OnGainBuff(unit, buff)
 ...
 if unit and unit.team == TEAM_ENEMY and unit.type == 'obj_AI_Hero' and buff.name == 'yasuoq3mis'  then 
    table.in(unitsknocked,unit)
    end 
   for i, buffs in pairs(buffTable) do  
   if unit and unit.team == TEAM_ENEMY and unit.type == 'obj_AI_Hero' and buff.name == buffs then 
  table.remove(unitsknocked,unit)
  end 
 end 
end   
