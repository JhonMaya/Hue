...
function OnProcessSpell(unit, spell)
  ...
  if menu.comboextra.others.combatAssist then
    if useEvadeee_ and myPlayer:CanUseSpell(_E) == READY and _G.Evadeee or _G.Evadeee_impossibleToEvade or _G.NotForcedToEvade() then
...
function OnDraw()
    ...
    if ValidTarget(Target) and TargetIsValid(Target) and GetDistance(Target) <= rangeToTarget then
      ...
      if damageWithR_ then
        DrawText3D(tostring(TextTest), Target.x, Target.y, Target.z, 26, ARGB(255, 000, 000, 255), true)
      end
    end
-- x-200, y*600
    if passive_ then       
