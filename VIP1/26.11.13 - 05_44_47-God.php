...
function Volley()
        if WAble and AutoCarry.PluginMenu.useW and not AutoCarry.Orbwalker:IsShooting() then ProdictW:GetPredictionCallBack(Target, CastW)
        end
end    
 
function Volley2()
        if WAble and AutoCarry.PluginMenu.useW2 and not AutoCarry.Orbwalker:IsShooting() then ProdictW:GetPredictionCallBack(Target, CastW)
        end
end
