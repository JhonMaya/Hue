<?php exit() ?>--by Hellsing 91.96.215.21
local scriptName = "Kassadin"
local printMessage = function(message) print("<font color=\"#00A300\"><b>"..scriptName..":</b></font> <font color=\"#FFFFFF\">"..message.."</font>") end
	...
	function OnLoad()
		...
		--{ Initiate Menu
			...
			--{ Draw Settings
				...
				DrawHandler:CreateCircle(mousePos,270,5,{255, 255, 255, 255}):AddToMenu(Menu.Draw, "Safe R Range", true, true, true)
