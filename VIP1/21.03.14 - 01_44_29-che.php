...
JMenu:addParam("Versao", "Version", SCRIPT_PARAM_INFO, version)
		...
		--Itens Helper
		JMenu:addSubMenu("Itens Helper", "itens") --OK
...
function LevelManaBase()
	if myHero.level == 6 and not ManaPerLvl == 80 and not ManaPerLvl == 10 then
		JMenu.diversos.StopHarassPorcentagem = ManaPerLvl - 10
	end
	if myHero.level == 10 and not ManaPerLvl == 80 and not ManaPerLvl == 10 then
		JMenu.diversos.StopHarassPorcentagem = ManaPerLvl - 10
	end
	if myHero.level == 16 and not ManaPerLvl == 80 and not ManaPerLvl == 10 then
		JMenu.diversos.StopHarassPorcentagem = ManaPerLvl - 10
	end
end 
...
if JMenu.diversos.UsarOrbwalking and not usingUlt then
 if Target ~= nil then OrbWalking(Target) else moveToCursor() end
end 
