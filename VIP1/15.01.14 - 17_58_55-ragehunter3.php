...
UserContent = {"xPain", "ragehunter3", "pqmailer", "Gintoci", "Erwinbeck", "woddystory", "Dyrone", "blm95", "changster109", "Errinqq", "Sehcure", "catbert", "asianone89", "thizz4win", "Supreme", "heel", "taka9999", "Shivan", "Melody", "Frosttfire", "xuzhe56828608", "kry0", "CLG Ahpromoo", "Solenrus", "ddsq1226"}
local authed = false
...
function OnLoad()
	...
	print("<font color='#FFFF00'>Viktorious Viktor: Loaded</font>")
	VP = VPrediction()
	...
	Menu.Skills:addParam("wHC", "W HitChange", SCRIPT_PARAM_SLICE, 2,0,5,0)
...
function OnTick()
	...
	KS()
		...
		myHero:MoveTo(mousePos.x, mousePos.z) -- FIND A WAY TO LOOP THIS INSTEAD OF MASS
		myHero:MoveTo(mousePos.x, mousePos.z) -- COPY PASTE.
	end
end
