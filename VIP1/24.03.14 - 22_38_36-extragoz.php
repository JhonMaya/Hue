<?php exit() ?>--by extragoz 190.225.243.97
--[[
	Cooldown Checker 1.7
		by eXtragoZ
...
function OnLoad()
	CDCConfig = scriptConfig("Cooldown Checker 1.7", "CooldownChecker")
	...
	PrintChat(" >> Cooldown Checker 1.7 loaded!")
end
function GetHPBarPos(champion)
	...
	return champion.isMe and {x = barPos.x-65, y = barPos.y-16} or (champion.team == myHero.team and {x = barPos.x-59, y = barPos.y-17} or {x = barPos.x-66, y = barPos.y-9})
end
function OnTick()
	for i=1, heroManager.iCount do
		local champion = heroManager:GetHero(i)
