<?php exit() ?>--by Jus 201.27.126.119
...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 1.27 -- version
...
local function HarassEnemy(myTarget)
  ...
  if harassMode_ == 1 then
    if hQ_ and GetDistance(myTarget) <= 550 and GetTickCount() + GetLatency()/2 - qTick > (1000/myPlayer.attackSpeed) - GetLatency()/2 then
  ...
  elseif harassMode_ == 2 then
    ...
    elseif hQ_ and GetDistance(myTarget) <= 275 and GetTickCount() + GetLatency()/2 - qTick > (1000/myPlayer.attackSpeed) - GetLatency()/2 and CastSpell(_Q, myTarget.x, myTarget.z) then
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            --print("AA")
          DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) and menu.combo.key or menu.extra.harass and not menu.farm.lasthit then CastQ(Target) end end, (qTick/1000 + spell.windUpTime - GetLatency()/2000))
        ...
        if ComboON then
            ...
            DelayAction(function() if ValidTarget(Target) and TargetIsValid(Target) and menu.combo.key or menu.extra.harass and not menu.farm.lasthit then
                                     myPlayer:Attack(Target)
                                   end 
                        end, 
                        lastAttackCD/1000 + spell.windUpTime - GetLatency()/2000)
            --myPlayer:Attack(Target)
	        	qTick = GetTickCount() + GetLatency() / 2
