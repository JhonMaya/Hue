...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 4.7
...
-Packet sniffer that highlights what changes often
-Blinking bars on how much damage can be done (on health) using opacity and sprites
-Tony
]]
--[[
Bugs
...
function canKill(target, combo)
	...
	elseif combo == 6 and target ~= nil then
		return (AAdamage ~= nil and AAdamage) > target.health
