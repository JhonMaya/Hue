...
local UPDATE_PATH = "/extrinsicdev/BoL/master/VixenVi.lua".."?rand="..math.random(1,100000)
local UPDATE_FILE_PATH = SCRIPT_PATH..GetCurrentEnv().FILE_NAME
local UPDATE_URL = "https://"..UPDATE_HOST..UPDATE_PATH
 
function _AutoupdaterMsg(msg) print("<font color=\"#6699ff\"><b>Vixen Vi:</b></font> <font color=\"#FFFFFF\">"..msg..".</font>") end
if AUTOUPDATE then
    local ServerData = GetWebResult(UPDATE_HOST, "/extrinsicdev/BoL/master/versions/VixenVi.version")
    if ServerData then
...
function mainMenu()
    Menu = scriptConfig("Vixen Vi","Vixen Vi")
