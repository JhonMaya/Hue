<?php exit() ?>--by dekaron2 81.132.58.21
...
function LoadVIPPrediction()
	...
	tpE = wp:AddProdictionObject(_E, rangeE, 1400, 0.25, nil, myHero, 
	function(unit, pos, castspell) 
		if GetDistance(pos) < rangeE and myHero:CanUseSpell(_E) == READY and not unit.dead then 
			CastSpell(_E, pos.x, pos.z)
		end 
	end)
	tpW = wp:AddProdictionObject(_W, rangeW, 1600, 0.25, nil, myHero, 
	function(unit, pos, castspell) 
		if GetDistance(pos) < rangeW and myHero:CanUseSpell(_W) == READY and not unit.dead then 
