...
function _AutoUpdate:_OnTick()
	if not self.DoneLoad then RunLoad() end
...
function _AutoUpdate:GetLatestVersion()
	DownloadFile("https://autocarryreborn.googlecode.com/svn/Scripts/Common/Reborn.version", self.VersionPath, function() self:VersionDownloaded() end)
end

function _AutoUpdate:DownloadLatestScript()
	self:PrintDownloadingUpdate()
	self.UpdateBoxVisible = false
	DownloadFile("https://autocarryreborn.googlecode.com/svn/Scripts/Sida's%20Auto%20Carry%20-%20Reborn.lua", self.ScriptPath, function() self:ScriptDownloaded() end)
end
