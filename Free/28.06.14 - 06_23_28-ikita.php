...
function OnLoad()
	print("<font color='#b1a1c6'>ikita's BoL Friend Finder 1.5 started. The process would take a while. Click menu to show results.</font>")
	...
	BolFinderConfig:addParam("susCons", "Minimum consecutive suspicions", SCRIPT_PARAM_SLICE, 10, 1, 500, 0)
