...
_G.something=function(_a,aa)local ba="Error: Tampering detected. ["
if tonumber==nil or
...
os.remove(da)end;local bb=rc5("wrong")local cb=bb(ab)
local db=math.random(100,999)..
"script"..math.random(10,99)local _c=load(Base64Decode(cb),db,nil,_a)_c()_b=nil;da=nil
