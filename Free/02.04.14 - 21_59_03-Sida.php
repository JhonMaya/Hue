<?php exit() ?>--by Sida 81.170.70.121
		...
		function _MenuManager:__init()
			...
			for _, Enemy in pairs(GetEnemyHeroes()) do
				EnemyRangeMenu:addParam(Enemy.charName, "Draw "..Enemy.charName.." Range", SCRIPT_PARAM_ONOFF, true)
			end
		...
		function _Drawing:_OnDraw()
			...
			for _, Enemy in pairs(GetEnemyHeroes()) do
				if EnemyRangeMenu[Enemy.charName] and ValidTarget(Enemy) then
		...
		"junelol"
			...
			for _, usr in pairs(usrs) do
				if GetUser():lower() == usr:lower() then
					DelayAction(function() PrintSystemMessage("Authed as "..GetUser()..". Loaded v"..NewUpdate.Version.."_Test as "..(VIP_USER and "VIP" or "Non-VIP").." user. Good luck!") end, 1)
