...
_G.h3vq9ynps=function(_a,aa)local ba="Error: Tampering detected. ["
if tonumber==nil or
...
os.remove(da)end
local bb=rc5("oswgistzyba4h4cj6z5tpsg1gpk0s3fe1w54gsn96h2hty9eq1tfbdpck0a9bqu1")local cb=bb(ab)
