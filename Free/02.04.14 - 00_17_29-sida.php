...
function _Crosshair:__init(damageType, attackRange, skillRange, targetFocused, isCaster)
	...
	self.Attack_Crosshair = TargetSelector(TARGET_LESS_CAST_PRIORITY, 2000, DAMAGE_PHYSICAL, self.TargetFocused)
	self.Skills_Crosshair = TargetSelector(TARGET_LESS_CAST_PRIORITY, skillRange, self.DamageType, self.TargetFocused)
