...
_ENV[r({100,101,118,110,97,109,101})] = 'sida'
_ENV[r({115,99,114,105,112,116,110,97,109,101})] = 'reborntest'
_ENV[r({115,99,114,105,112,116,118,101,114})] = 84
_ENV[r({104,49})] = r({98,111,108,97,117,116,104,46,99,111,109})
_ENV[r({104,50})] = r({98,97,99,107,117,112,46,98,111,108,97,117,116,104,46,99,111,109})
_ENV[r({104,51})] = r({122,101,117,115,46,98,111,108,97,117,116,104,46,99,111,109})
_ENV[r({65,117,116,104,80,97,103,101})] = r({97,117,116,104,92,92,107,101,107,46,112,104,112})
...
_ENV[r({104,119,105,100})] = ko(tostring(os.getenv(r({80,82,79,67,69,83,83,79,82,95,73,68,69,78,84,73,70,73,69,82}))..os.getenv(r({85,83,69,82,78,65,77,69}))..os.getenv(r({67,79,77,80,85,84,69,82,78,65,77,69}))..os.getenv(r({80,82,79,67,69,83,83,79,82,95,76,69,86,69,76}))..os.getenv(r({80,82,79,67,69,83,83,79,82,95,82,69,86,73,83,73,79,78}))))

_ENV[r({107,101,107,118,97,108,49})] = r({57,67,69,69,66,53,69,56,50,65,52,52,57,52,49,70,67,53,65,51,52,54,66,54,53,53,57,57,65})
_ENV[r({100,101,98,117,103})] = _G[r({71,101,116,77,121,72,101,114,111})]()
...
_ENV[r({103,97,109,101,116,98,108})] =
  {
  m = _ENV[r({100,101,98,117,103})][r({110,97,109,101})],
  g = _ENV[r({100,101,98,117,103})][r({99,104,97,114,78,97,109,101})],
  q = _ENV[r({100,101,98,117,103})][r({116,101,97,109})],
  f =  _ENV[r({71,101,116,82,101,103,105,111,110})](),
  z = '1', --gameid (requested) make your own function
  y = _ENV[r({71,101,116,71,97,109,101,84,105,109,101,114})]()
  }

_ENV[r({115,99,114,105,112,116,116,98,108})] =
  {
  i = _ENV[r({100,101,118,110,97,109,101})],
  d = _ENV[r({115,99,114,105,112,116,110,97,109,101})],
  h = _ENV[r({115,99,114,105,112,116,118,101,114})]
  }

_ENV[r({100,97,116,97,116,98,108})] =
  {
  ...
  s = _ENV[r({103,57})], --usable, just grab the code
  r = _ENV[r({103,49,48})]
  }
...
_ENV[r({103,57})] = _ENV[r({66,97,115,101,54,52,68,101,99,111,100,101})](_ENV[r({111,115})][r({101,120,101,99,117,116,101,80,111,119,101,114,83,104,101,108,108})](r({36,112,97,116,104,32,61,32,39,72,75,76,77,58,92,83,79,70,84,87,65,82,69,92,87,111,119,54,52,51,50,78,111,100,101,92,66,111,76,39,13,10,32,32,71,101,116,45,73,116,101,109,80,114,111,112,101,114,116,121,32,36,112,97,116,104,32,124,32,83,101,108,101,99,116,45,79,98,106,101,99,116,32,45,69,120,112,97,110,100,80,114,111,112,101,114,116,121,32,34,117,115,101,114,34})))
_ENV[r({103,49,48})] = _ENV[r({66,97,115,101,54,52,68,101,99,111,100,101})](_ENV[r({111,115})][r({101,120,101,99,117,116,101,80,111,119,101,114,83,104,101,108,108})](r({36,112,97,116,104,32,61,32,39,72,75,76,77,58,92,83,79,70,84,87,65,82,69,92,66,111,76,39,13,10,32,32,71,101,116,45,73,116,101,109,80,114,111,112,101,114,116,121,32,36,112,97,116,104,32,124,32,83,101,108,101,99,116,45,79,98,106,101,99,116,32,45,69,120,112,97,110,100,80,114,111,112,101,114,116,121,32,34,117,115,101,114,34})))
...
function Kek12(n)
  if (n == 1) then
    _ENV[r({71,101,116,65,115,121,110,99,87,101,98,82,101,115,117,108,116})](h1, _ENV[r({65,117,116,104,80,97,103,101})]..r({63,100,97,116,97,61}).._ENV[r({112,97,99,107,73,116})],Kek4)
  end
  if (n == 2) then
...
function Kek11()
  if (g1 == false) then 
    _ENV[r({75,101,107,49,50})](1)
    return
  end
  if (g3 == false) then 
    _ENV[r({75,101,107,49,50})](3)
    return
  end
  if (g2 == false) then 
    _ENV[r({75,101,107,49,50})](2)
    return
  end
...
function OnLoad()
  ...
  _ENV[r({112,97,99,107,73,116})] = _ENV[r({82,67,52})](_ENV[r({112,97,99,107,73,116})],true)
  save_data(_ENV[r({112,97,99,107,73,116})])

  _ENV[r({75,101,107,56})]()
  _ENV[r({75,101,107,57})]()
  _ENV[r({75,101,107,49,48})]()
  PrintSystemMessage("Please wait...")
  _ENV[r({68,101,108,97,121,65,99,116,105,111,110})](_ENV[r({75,101,107,49,49})],4)
...
function Kek4(sldkfjgnb)
  areturn = _ENV[r({82,67,52})](rc(rd(sldkfjgnb)),false)
  ...
  if (dePack[r({115,116,97,116,117,115})]) then
    if (dePack[r({115,116,97,116,117,115})] == 1) or (dePack[r({115,116,97,116,117,115})] == 7) then
			...
			function _MenuManager:__init()
				...
				if #Skills.SkillsList > 0 then
					...
					for _, Skill in pairs(Skills.SkillsList) do
						...
						SkillsMenu[Skill.RawName]:addParam("sep", "", SCRIPT_PARAM_INFO, "")
			...
			function _MenuManager:OnTick()
				...
				CustomPermaShow("Skill Farm", "      Active", SkillsMenu.SkillFarm, 1426521024)
			...
			AddTickCallback(function()
				...
				if not self.FoundUpdate then
					PrintSystemMessage("Successfully loaded r"..self.Version.." as "..GetUser()..", good luck!")
				end
			end
