...
---------------------------------- START UPDATE ---------------------------------------------------------------
local versionGOE = 1.31 -- current version
...
Menu = AutoCarry.Plugins:RegisterPlugin(Plugin(), "aEvelynn v1.2")
Menu:addParam("Information1", "  aEvelynn v1.2 by Anonymous", SCRIPT_PARAM_INFO, "")
