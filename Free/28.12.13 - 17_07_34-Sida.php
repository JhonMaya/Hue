...
local particlespeeds = {}
local saveToParticleLog = {}
local saveToBuffLog = {}
local spells = {}
local count = 0
...
local function DrawLine3D(x1,y1,z1,x2,y2,z2,linesize, linecolor)
...
function OnWndMsg(msg, key)
    ...
    --Keboard (Numpad)
    if key == string.byte("H") and msg == KEY_DOWN and state ~= 3 then state = 2 -- 0
    elseif key == string.byte("H") and msg == KEY_UP and state == 2 then state = 1 -- 0
...
function OnLoad()
    PrintChat(" >> Dekland Info script")
    Config = scriptConfig("Dekland Info", " Skill Info")
    Config:addParam("q", "Activate (Q) F1", SCRIPT_PARAM_ONKEYTOGGLE, false, 112)
    Config:addParam("w", "Activate (W) F2", SCRIPT_PARAM_ONKEYTOGGLE, false, 113)
    Config:addParam("e", "Activate (E) F3", SCRIPT_PARAM_ONKEYTOGGLE, false, 114)
    Config:addParam("r", "Activate (R) F4", SCRIPT_PARAM_ONKEYTOGGLE, false, 115)
    Config:addParam("i", "Activate (Items)", SCRIPT_PARAM_ONKEYTOGGLE, false, 73)
