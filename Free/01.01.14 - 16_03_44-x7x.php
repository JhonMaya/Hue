...
function isChanneling()
	if myHero.charName == "Nunu" or myHero.charName == "MissFortune" or myHero.charName == "FiddleSticks" or myHero.charName == "Malzahar" or myHero.charName == "Katarina" or myHero.charName == "Janna" then
