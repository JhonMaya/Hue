...
function UpdateScriptGOE()
	if needRun_GOE then
		needRun_GOE = false
		if _G.UseUpdater == nil or _G.UseUpdater == true or _G.UseUpdater == false then GetAsyncWebResult("anonymous-dev.y0.pl", SCRIPT_NAME_GOE.."Ver.lua", CheckVersionGOE) end
	end
...
function OnLoad()
	if VIP_USER then QProdict = Prodiction:AddProdictionObject(_Q, 825, 1200, 0.25, 80, myHero) else QProdict = TargetPrediction(825, 1.2, 250, 80, 0) end
