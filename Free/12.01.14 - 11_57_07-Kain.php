...
function Menu()
	...
	Menu:addSubMenu("["..myHero.charName.." Auto Carry: Advanced]", "Advanced")
		Menu.Advanced:addParam("WEDistanceFromEnemy", "W/E Cast Distance from Enemy", SCRIPT_PARAM_SLICE, 125, 10, 600, 0)
		...
		Menu.Advanced:addParam("SatchelJumpDistance", "Satchel Jump Distance", SCRIPT_PARAM_SLICE, 125, 10, 300, 0)
