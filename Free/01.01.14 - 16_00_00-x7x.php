...
--[[ 		ABU v1.0 - Anti Break Ultimates: Revamped!		 ]]--
_G.ABUuseSACRevamped = true	-- Block SAC:Revamped movements and attacks.
_G.ABUuseSACReborn = true	-- Block SAC:Reborn movements and attacks.
_G.ABUuseMMA = true			-- Block MMA movements.
_G.ABUuseEvadeee = true		-- Block Evading while channeling spells.
_G.ABUusePackets = true		-- Block player attempts to attack, spell casitng and movements ( VIP ONLY ).
--[[
	SUPPORTED SPELLS:
	- Katarina R
	- Nunu R
