...
function PluginOnTick()
	...
	if AutoCarry.PluginMenu.noAttack and AutoCarry.MainMenu.AutoCarry then AutoCarry.MyHero:AttacksEnabled(false) AutoCarry.MyHero:Move() else AutoCarry.MyHero:AttacksEnabled(true) end
	-- Exploit
