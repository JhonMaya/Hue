...
function OnLoad()
	Variables()
	LeblancMenu()
	PrintChat("<font color='#FFFF00'> >> Leblanc - The Deceiver 1.3 Loaded!! <<</font>")
end
...
function SmartCombo()
	...
	if Target and Target.valid then
		...
		local ComboDamage = ComboGetDamage(BestCombo, Target)
		ExecuteCombo(BestCombo, Target)
		if DeadTarget ~= nil and DeadTarget.dead and LeblancMenu.combo.wBack then
			if wUsed() then
				CastSpell(_W)
			end
		end
