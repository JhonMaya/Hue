...
function StealJungle()
	...
	if Nashor ~= nil and GetDistance(Nashor) < RRange and Nashor.visible then KillJungle(Nashor) end -- Baron
	if Dragon ~= nil and GetDistance(Dragon) < RRange and Dragon.visible then KillJungle(Dragon) end
	if Golem1 ~= nil and GetDistance(Golem1) < RRange and Golem1.visible then KillJungle(Golem1) end -- Bottom Left Blue
	if Golem2 ~= nil and GetDistance(Golem2) < RRange and Golem2.visible then KillJungle(Golem2) end -- Top Right Blue
	if Lizard1 ~= nil and GetDistance(Lizard1) < RRange and Lizard1.visible then KillJungle(Lizard1) end
	if Lizard2 ~= nil and GetDistance(Lizard2) < RRange and Lizard2.visible then KillJungle(Lizard2) end	
end
...
function KillJungle(object)
	...
	if QReady and GetDistance(object) < QMaxRange and object.health  + 25 < getDmg("Q", object, myHero) + 5000 then
