...
function _AutoUpdate:GetLatestVersion()
	...
	DelayAction(function() DownloadFile("https://autocarryreborn.googlecode.com/svn/trunk/Scripts/Common/Reborn.version", self.VersionPath, function() self:VersionDownloaded() end) end, 0.5)
end
...
function _AutoUpdate:DownloadLatestScript()
	...
	DelayAction(function() DownloadFile("https://autocarryreborn.googlecode.com/svn/trunk/Scripts/Sida's%20Auto%20Carry%20-%20Reborn.lua", self.ScriptPath, function() self:ScriptDownloaded() end) end, 1)
end
