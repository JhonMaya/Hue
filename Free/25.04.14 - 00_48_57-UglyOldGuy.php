...
local NintendoUsers = {"RoachxD", "UglyOldGuy", "asiangirl", "bothappy", "hellking298", "xtony211", "CoDice", "Uruu", "tjtjsqh", "Vortur"}
...
if not NintendoUser() or not DrugTest() then return end
