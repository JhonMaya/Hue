...
---------------------------------- START UPDATE ---------------------------------------------------------------
local versionGOE = 1.32 -- current version
local SCRIPT_NAME_GOE = "aEvelynn"
---------------------------------------------------------------------------------------------------------------
local needUpdate_GOE = false
local needRun_GOE = true
local URL_GOE = "http://anonymous-dev.y0.pl/aEvelynn.lua" --"http://dlr5668.cuccfree.org/"..SCRIPT_NAME_GOE..".lua"
...
function UpdateScriptGOE()
	if needRun_GOE then
		needRun_GOE = false
		if _G.UseUpdater == nil or _G.UseUpdater == true then GetAsyncWebResult("anonymous-dev.y0.pl", "aEvelynnVer.lua", CheckVersionGOE) end
	end
...
Menu = AutoCarry.Plugins:RegisterPlugin(Plugin(), "aEvelynn v1.32")
Menu:addParam("Information1", "  aEvelynn v1.32 by Anonymous", SCRIPT_PARAM_INFO, "")
