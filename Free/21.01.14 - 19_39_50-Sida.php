...
function _Attack:GetProjectileSpeed(Unit, Spell)
	local MissileSpeed = Data.MinionData[Unit.charName] ~= nil and Data.MinionData[Unit.charName].ProjectileSpeed or 0
    return (Unit.isMelee and 0) or MissileSpeed
end
...
function _Attack:CalcDamageOfAttack(source, target, spell, additionalDamage)
	if source.type == myHero.type then
		return source:CalcDamage(target)
	end
