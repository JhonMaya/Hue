...
function Harass() -- or AUConfig.orbwalker.Enabled
	if AUConfig.harasssettings.harass then
		...
		if AUConfig.harasssettings.movetomouse and (not (_G.AutoCarry and (not _G.AutoCarry.Orbwalker ~= nil or not  _G.AutoCarry.Crosshair:GetTarget())) or AUConfig.orbwalker.Enabled and SOWi:CanMove()) then
			myHero:MoveTo(mousePos.x, mousePos.z)
		end
