...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 0.073
...
function CastW(Target)
	if Target == nil or Target.dead or not ValidTarget(Target) or GetDistance(Target) > 1250 then 
		return 
	end
	if Target ~= nil and not Target.dead and WReady and GetDistance(Target) < Config.Extras.WDistance and not IsMyManaLow() then
		CastSpell(_W, Target)
	elseif WReady and GetDistance(Target) < 1500  and GetDistance(Target) > Config.Extras.WChaseDistance and not IsMyManaLow() and CheckAngle(Target) then
