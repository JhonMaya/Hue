...
local UPDATE_FILE_PATH = SCRIPT_PATH.."Rumble3.lua"
local UPDATE_FILE_PATH = string.gsub(UPDATE_FILE_PATH, "\\", "/")
print(UPDATE_FILE_PATH)
local UPDATE_URL = "https://raw.github.com/Dienofail/BoL/master/paid/Rumble.lua" .. "?rand=" .. math.random(1,100000)
    ...
    if ServerData then
        ...
        if ServerVersion then
            ...
            if tonumber(version) < ServerVersion then
                ...
                DownloadFile(UPDATE_URL, UPDATE_FILE_PATH, function () print('Downloading...DienoRumble') end)
