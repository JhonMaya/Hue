<?php exit() ?>--by ZTempAccount 79.253.204.182
if myHero.charName~="Ziggs"then return end;require"VPrediction"
local N9L="1.1"local hDc_M=true;local qW0lRiD1="raw.github.com"
...
print("<font color=\"#FF0000\"><b>Ziggs Combo:</b> You have got the latest version xd: <u><b>"..qL.."</b></u></font>")end;R1FIoQI=nil end end;AddTickCallback(update)end;local NsoTwDs='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'
function enc(qboV)
return
(
(
