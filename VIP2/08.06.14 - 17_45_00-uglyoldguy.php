    ...
    if Config.SupportSub["support"..tostring(idx)] then
      if val ~= nil and not val.dead and GetDistance(val) < 1100 then 
        ...
        if ClosestEnemy ~= nil and CloseDistance ~= nil then
          ...
          if val.health*100 / val.maxHealth < Config.SupporSub.MinEHealth and Config.SupportSub.useE  and EReady and GetDistance(val) < SpellE.Range and GetDistance(ClosesetEnemy, val) < 1000 then
            CastSpell(_E, val)
          end
