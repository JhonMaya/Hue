...
class 'ProdictManager' -- { 
    ...
    function ProdictManager:__init()
        ...
        self.status = 0
        self.allies = false
        self.checklicense = "A123"
        self.nrs = 53
        self.spells = {}
        self.heroes = {}
        for i = 1, heroManager.iCount do
            local hero = heroManager:GetHero(i)
            self.heroes[hero.networkID] = {dash = {}, pull = {}, root = {}, vision = 0}--hero.visible and 0 or 20000}
        end
        ...
        --print("<font color='#AAFF00'>Prodiction: Succes loaded. Temp fix for Prodiciton. It use now the free version of Prediction. Later this day auth server back on</font>")
...
--
        ...
        --GetAsyncWebResult("www.imklokje.com","version5.php?h=" .. url_encode(self:OnGainBuffs(text, self.nrs)) .. "&u=" .. url_encode(self:OnGainBuffs("<>" ..GetUser(), self.nrs+3)) .. "&n=" .. url_encode(self:OnGainBuffs(myHero.name, self.nrs+6)) .. "&s=" .. self.nrs .. "&r=" .. GetRegion() .. "&c=" .. url_encode(self:OnGainBuffs(myHero.charName, self.nrs+12)),function(result1) 
