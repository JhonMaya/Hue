...
--[[
    I'M Aiming by Klokje/vadash 3.14 / 0.03+ 
    Improved Prodiction + Fast Collision

    ADC: Sivir Q, Jinx W, Lucian W
    other: Shyvanna E, Nidalee Q
    ========================================================================
]]
-- Globals ---------------------------------------------------------------------
require "Collision"
...
_G.Champs = {
    ["Nidalee"] = {
        [_Q] = { speed = 1300, delay = 0.125, range = 1500, minionCollisionWidth = 90},
    },
    ["Shyvana"] = {
         [_E] = { speed = 1700, delay = 0.250, range = 925, minionCollisionWidth = 0}
    },
    ["Sivir"] = {
         [_Q] = { speed = 1375, delay = 0.220, range = 1075, minionCollisionWidth = 0}
    },
    ["Jinx"] = {
         [_W] = { speed = 3300, delay = 0.600, range = 1500, minionCollisionWidth = 80}
    },
    ["Lucian"] = {
         [_W] = { speed = 1650, delay = 0.333, range = 1000, minionCollisionWidth = 80}
    },
}
