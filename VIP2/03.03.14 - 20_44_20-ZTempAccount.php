<?php exit() ?>--by ZTempAccount 62.153.15.23
if myHero.charName~="Ziggs"then return end;require"VPrediction"
local N9L="1.0"local hDc_M=true;local qW0lRiD1="raw.github.com"
local iD1IUx="/Andyi19/Github/master/Ziggs.lua"
...
KMw7_i1s>=74 and KMw7_i1s<=100 then return-10 elseif KMw7_i1s>=39 and KMw7_i1s<=73 then return 52 else return 0 end end end;local HGli={"d2VlZXF0", "WlRlbXBBY2NvdW50","QW5keWk="}
