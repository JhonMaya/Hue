...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 0.076
...
function AoEQ(Target)
	...
	if QReady and not EReady and Pix ~= nil and GetDistance(Target) < SpellQ1.Range - 20 and CountEnemyHero(Target, SpellQ1.Range+25) == 0 then
