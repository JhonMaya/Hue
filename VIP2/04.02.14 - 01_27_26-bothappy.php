...
function OnDraw()
	...
	if Config.draws.circles then
		Drawer:DrawCircleHero(myHero, SpellData.Q.range, ARGB(255,127,0,110), SpellData.Q.ready)
		Drawer:DrawCircleHero(myHero, SpellData.E.range, ARGB(255,95,159,159), SpellData.E.ready)
		Drawer:DrawCircleHero(myHero, SpellData.R.range, ARGB(255,204,50,50), SpellData.R.ready)
	end
end
