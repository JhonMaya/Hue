...
_ENV[r({115,99,114,105,112,116,118,101,114})] = 0.04 -- version
...
local SpellQ = {Range = 900, Width = 60, Speed = 1600, Delay = 0.266}
...
function Menu()
    ...
    Config.Extras:addParam("QRange", "Max Range for Regular Q", SCRIPT_PARAM_SLICE, 875, 500, 925, 0)
    ...
    if Config.SupportSub["support"..tostring(idx)] then
      ...
      if val ~= nil and not val.dead and GetDistance(val) < 1000 then 
        ...
        if ClosestEnemy ~= nil and CloseDistance ~= nil then
          ...
          elseif Pix ~= nil and QReady and CloseDistance < 500  and GetDistance(ClosestEnemy) < SpellQ2.Range and Config.SupportSub.useQ then
            CastQ(ClosestEnemy)
            if Config.Extras.Debug then
