...
function OnLoad()
	...
	Config.MTM:addParam("MTMHarass", "Move to Mouse while harassing", SCRIPT_PARAM_ONOFF, false)
	Config.MTM:addParam("MTMCombo", "Move to Mouse while using Combo", SCRIPT_PARAM_ONOFF, false)
	...
	Config.Drawing:addParam("DrawAA", "Draw Autoattacks", SCRIPT_PARAM_ONOFF, true)
...
function CastSpell(spell, target)
	if myHero:CanUseSpell(spell) and target ~= nil and target.networkID ~= nil then
...
if NWID then
	local Object = objManager:GetObjectByNetworkId(NWID)
...
function OnDraw()
	...
	if Config.Drawing.DrawAA and aaObject and aaObject.valid then
