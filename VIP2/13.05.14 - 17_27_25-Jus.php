...
function OnProcessSpell(unit, spell)
	...
	if unit.isMe then
		...
		if spell.name:lower():find("lissandrae") and ValidTarget(Target) then
			if e_ and secondE ~= nil and CountEnemyHeroInRange(gap_2, secondE) <= gap_1 and GetDistance(Target, sencondE) <= GeDistance(spell.endPos) or GetDistance(Target, secondE) <= gap_2 then
