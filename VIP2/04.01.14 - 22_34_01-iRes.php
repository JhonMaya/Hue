...
--[[
        ...
        Team GermanAutoWin presents: Brand, deadly Napalm hits League of Legends!
        A script by GermanTank and GermanJet!
                Features:
                        -       Prodiction on Q, W !
                        -       Orbwalking (Toggle)
                        -       Auto Harass E, W , Q
                        -       Harass Function
                        -       Full Q, W, E, R Combo
                        -       Smart Combo in Teamfights ( calculates where most of the damage is archievable)
                        -       Ks Option ( uses the smartest one)
                        -       Drawings
                                        - Q, W, E, R Range (Turn on/off)
                                        - On enemy drawings (killable, full combo kill etc.)
]]--
