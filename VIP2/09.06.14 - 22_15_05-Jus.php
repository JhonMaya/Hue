...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 1.5
  ...
  --------use---------
    ...
    if unit.isMe then      
        ...
        --print("PROCESS: AA")          
            ...
            DelayAction(function() if spell.Target ~= nil then SendQ() end end, (spell.windUpTime)/2 + (spell.animationTime)/2 - GetLatency() / 2000)
          --print("3) AA")
...
function LineFarm()  
    ...
    if JungleLaneMinion ~= nil and not JungleLaneMinion.dead then
     if mode_ == 2 and GetTickCount() + GetLatency() / 2 > lTick then myPlayer:Attack(JungleLaneMinion) CastCommonItem(JungleLaneMinion) end                  
        if qLane_ and GetDistance(JungleLaneMinion, myPlayer) <= 550 and PassiveIndicator <= 2 then
    ...
    if JungleLaneMinion ~= nil then SmiteBuffMob() end
