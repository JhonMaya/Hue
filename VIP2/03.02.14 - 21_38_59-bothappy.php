...
if myHero.charName ~= "Nidalee" and myHero.charName ~= "Kayle" and myHero.charName ~= "Akali" and myHero.charName ~= "Talon" then return end
...
_G.class 'SADrawer' 
    ...
    function SADrawer:__init(red, green, blue, alpha)
        self._R = red or 255
    ...
    function SADrawer:__type()
        return "SADrawer"
    end

    function SADrawer.FromARGB(red, green, blue, alpha)
        return SADrawer(red,green,blue, alpha)
    end

    function SADrawer:A(number)
        self._A = number or 255
        return self
    end 

    function SADrawer:R(number)
        self._R = number or 255
        return self
    end

    function SADrawer:B(number)
        self._B = number or 255
        return self
    end

    function SADrawer:G(number)
        self._G = number or 255
        return self
    end

    function SADrawer:ToARGB()
        return ARGB(self._A, self._R, self._G, self._B)
    end

    SADrawer = {
        AliceBlue = SADrawer(240, 248, 255, 255),
        AntiqueWhite = SADrawer(250, 235, 215, 255),
        Aqua = SADrawer(0, 255, 255, 255),
        AquaMarine = SADrawer(127, 255, 212, 255),
        Azure = SADrawer(240, 255, 255, 255),
        Beige = SADrawer(245, 245, 196, 255),
        Bisque = SADrawer(255, 228, 196, 255),
        Black = SADrawer(0, 0, 0, 255),
        BlancheDalmond = SADrawer(255, 235, 205, 255),
        Blue = SADrawer(0, 0, 255, 255),
        BlueViolet = SADrawer(138, 43, 226, 255),
        Brown = SADrawer(165, 42, 42, 255),
        BurlyWood = SADrawer(222, 184, 135, 255),
        CadetBlue = SADrawer(92, 158, 160, 255),
        ChartReuse = SADrawer(127, 255, 0, 255),
        Chocolate = SADrawer(210, 105, 30, 255),
        Coral = SADrawer(255, 127, 80, 255),
        CornFlowerBlue = SADrawer(100, 149, 237, 255),
        CornSilk = SADrawer(255, 248, 220, 255),
        Crimson = SADrawer(220, 20, 60, 255),
        Cyan = SADrawer(0, 255, 255, 255),
        DarkBlue = SADrawer(0, 0, 139, 255),
        DarkCyan = SADrawer(0, 139, 139, 255),
        DarkGoldenRod = SADrawer(184, 134, 11, 255),
        DarkGray = SADrawer(169, 169, 169, 255),
        DarkGreen = SADrawer(0, 100, 0, 255),
        DarkKhaki = SADrawer(189, 183, 107, 255),
        DarkMagenta = SADrawer(139, 0, 139, 255),
        DarkOliveGreen = SADrawer(85, 107, 47, 255),
        DarkOrange = SADrawer(255, 140, 0, 255),
        DarkOrchid = SADrawer(153, 50, 204, 255),
        DarkRed = SADrawer(139, 0, 0, 255),
        DarkSalmon = SADrawer(233, 150, 122, 255),
        DarkSeaGreen = SADrawer(143, 188, 143, 255),
        DarkSlateBlue = SADrawer(72, 61, 139, 255),
        DarkSlateGray = SADrawer(47, 79, 79, 255),
        DarkTurquoise = SADrawer(0, 206, 209, 255),
        DarkViolet = SADrawer(148, 0, 211, 255),
        DeepPink = SADrawer(255, 20, 147, 255),
        DeepSkyBlue = SADrawer(0, 191, 255, 255),
        DimGray = SADrawer(105, 105, 105, 255),
        DodgerBlue = SADrawer(30, 144, 255, 255),
        FireBrick = SADrawer(178, 34, 34, 255),
        FloralWhite = SADrawer(255, 250, 240, 255),
        ForestGreen  = SADrawer(34, 139, 34, 255),
        Fuchsia = SADrawer(255, 0, 255, 255),
        GainsBoro = SADrawer(220, 220, 220, 255),
        GhostWhite = SADrawer(255, 250, 240, 255),
        Gold = SADrawer(255, 215, 0, 255),
        GoldenRod = SADrawer(218, 165, 32, 255),
        Gray = SADrawer(128, 128, 128, 255),
        Green = SADrawer(0, 255, 0, 255),
        GreenYellow = SADrawer(173, 255, 47, 255),
        HoneyDew = SADrawer(240, 255, 240, 255),
        HotPink = SADrawer(255, 105, 180, 255),
        IndianRed = SADrawer(205, 92, 92, 255),
        Indigo = SADrawer(75, 0, 130, 255),
        Ivory  = SADrawer(255, 255, 240, 255),
        Khaki = SADrawer(240, 230, 140, 255),
        Lavender = SADrawer(230, 230, 250, 255),
        LavenderBlush = SADrawer(255, 240, 245),
        LawnGreen = SADrawer(124, 252, 0, 255),
        LemonChiffon = SADrawer(255, 250, 205, 255),
        LightBlue = SADrawer(173, 216, 230, 255),
        LightCoral = SADrawer(240, 128, 128, 255),
        LightCyan = SADrawer(240, 128, 128, 255),
        LightGoldenRodYellow = SADrawer(250, 250, 210, 255),
        LightGray = SADrawer(211, 211, 211, 255),
        LightGreen = SADrawer(144, 238, 144, 255),
        LightPink = SADrawer(255, 182, 193, 255),
        LightSalmon = SADrawer(255, 160, 122, 255),
        LightSeaGreen = SADrawer(32, 178, 170, 255),
        LightSkyBlue = SADrawer(135, 206, 250, 255),
        LightSlateGray = SADrawer(119, 136, 153, 255),
        LightSteelBlue = SADrawer(176, 196, 222, 255),
        LightYellow = SADrawer(255, 255, 224, 255),
        Lime = SADrawer(0, 255, 0, 255),
        LimeGreen = SADrawer(50, 205, 50, 255),
        Linen = SADrawer(250, 240, 230, 255),
        Magenta = SADrawer(255, 0, 255, 255),
        Maroon = SADrawer(128, 0, 0, 255),
        MediumAquaMarine  = SADrawer(102, 205, 170, 255),
        MediumBlue = SADrawer(0, 0, 205, 255),
        MediumOrchid = SADrawer(186, 85, 211, 255),
        MediumPurple = SADrawer(147, 112, 219, 255),
        MediumSeaGreen = SADrawer(60, 179, 113, 255),
        MediumSlateBlue = SADrawer(123, 104, 238, 255),
        MediumSpringGreen = SADrawer( 0, 250, 154, 255),
        MediumTurquoise = SADrawer(72, 209, 204, 255),
        MediumVioletred = SADrawer(199, 21, 133, 255),
        Midnightblue = SADrawer(25, 25, 112, 255),
        MintCream = SADrawer(245, 255, 250, 255),
        MistyRose = SADrawer(255, 228, 225, 255),
        Red = SADrawer(255, 0, 0, 255),
        Yellow = SADrawer(255, 255, 0, 255),
        Green = SADrawer(0, 255, 0, 255),
        Fuchsia = SADrawer(255, 0, 255, 255),
        White = SADrawer(255, 255, 255, 255),
    }

	function SADrawer:DrawCircleHero(hero, range, colorName, ready)
        if ready then
	...
	function SADrawer:DrawTextEnemy(hero, text, colorName)
    ...
    function SADrawer:DrawOnHPBar(unit, text, colorName)
    ...
    function SADrawer:_GetHPBarPos(enemy)
    ...
    function SADrawer:DrawIndicator(unit, health, colorName)
...
_G.class 'SAHero'
	...
	function SAHero:__init()
		self.myTrueRange = myHero.range + GetDistance(myHero.minBBox)
	end

    function SAHero:__type()
        return "SAHero"
    end

	function SAHero:TrueRange(unit)
		return unit.range + GetDistance(unit.minBBox)
	end

	function SAHero:CountInRange(range, hero)
...
_G.class 'SAHelper'
	...
	function SAHelper:__init()
		self.initialTick = GetTickCount()
		AddTickCallback(function() self:_OnTick() end)
	end

    function SAHelper:__type()
        return "SAHelper"
    end

	function SAHelper:_OnTick()
		SAHelper.actualTick = GetTickCount()
		SAHelper.latency = GetLatency()
	end

	function SAHelper:MoveToPos(position)
	...
	function SAHelper:DecToHex(Dec)
	...
	function SAHelper:Evading()
		return _G.evade or _G.evading
	end

	function SAHelper:HeroTarget(target)
    ...
    function SAHelper:__validTarget(unit, distance)
        return ((ValidTarget(unit, distance) and unit.bTargetable and unit.type:lower() == "obj_ai_hero") and true or false)
    end

    function SAHelper:__correctDistance(unit, distance)
        return GetDistanceSqr(unit) < distance*distance
    end

    function SAHelper:__deepCopyTable(orig) --To copy a whole table
...
_G.class 'SAItems'
    ...
    function SAItems:__init(itemName)
    ...
    function SAItems:UseRanduins()
        local ally, enemy = SAHero:CountInRange(500, myHero)
        if enemy > 2 then
			CastItem(3143)
		end
    end

    function SAItems:UseSolari()
        local ally, enemy = SAHero:CountInRange(600, myHero)
		if ally > 2 then
			CastSpell(3190)
        end
    end
...
_G.class 'SAMap'
    ...
    function SAMap:__init()
        self.name = GetGame().map.shortName
    end

    function SAMap:__type()
        return "SAMap"
    end

    function SAMap:TwistedTreeline()
...
_G.class 'SAPriorities'
    ...
    function SAPriorities:__type()
        return "SAPriorities"
    end

	function SAPriorities:Load()
		if SAMap():TwistedTreeline() and (#GetEnemyHeroes() >2) then
	...
	function SAPriorities:_ArrangePrioritys()
	...
	function SAPriorities:_ArrangeTTPrioritys()
		for i, enemy in pairs(GetEnemyHeroes()) do
			self:_SetPriority(_priorityTable.AD_Carry, enemy, 1)
	...
	function SAPriorities:_SetPriority(table, hero, priority)
	    for i=1, #table, 1 do
...
_G.class 'SAmostEnemies'

    function SAmostEnemies:GetCenter(points)
        local sum_x = 0
        local sum_z = 0
    ...
    function SAmostEnemies:ContainsThemAll(circle, points)
    ...
    function SAmostEnemies:FarthestFromPositionIndex(points, position)
        local index = 2
    ...
    function SAmostEnemies:RemoveWorst(targets, position)
        local worst_target = SAmostEnemies:FarthestFromPositionIndex(targets, position)
    ...
    function SAmostEnemies:GetInitialTargets(radius, main_target)
    ...
    function SAmostEnemies:GetPredictedInitialTargets(radius, main_target, delay)
    ...
    function SAmostEnemies:GetCircleMEC(radius, main_target, delay)
            local targets = delay and SAmostEnemies:GetPredictedInitialTargets(radius, main_target, delay) or SAmostEnemies:GetInitialTargets(radius, main_target)
    ...
    function SAmostEnemies:CountEnemies(point, range)
        local ChampCount = 0
...
--[[
	Class: SASummoners
	Version: 0.02
	Usage: SASummoners cast and SAHelper
	TO-DO:
...
_G.class 'SASummoners'
    ...
    function SASummoners:__init()
        
    end

    function SASummoners:__type()
        return "SASummoners"
    end

	function SASummoners:CheckSummoners(name)
        for _, summoner in pairs(SASummoners.List) do
    ...
    function SASummoners:SmiteDmg(level)
...
-------------------------------------------------------
--[[
    Class: SACollision with Prodiction
    Version: 0.01
]]
-------------------------------------------------------
...
_G.class 'SACollision' 
    HERO_ALL = 1
    HERO_ENEMY = 2
    HERO_ALLY = 3
 
 
    function SACollision:__init(sRange, projSpeed, sDelay, sWidth)
        uniqueId = uniqueId + 1
    ...
    function SACollision:GetMinionCollision(pStart, pEnd)
    ...
    function SACollision:GetHeroCollision(pStart, pEnd, mode)
    ...
    function SACollision:GetCollision(pStart, pEnd)
...
_G.class 'SACombatHandler'

    function SACombatHandler:__init(TargetSelector)
    ...
    function SACombatHandler:__type()
        return "SACombatHandler"
    end

    function SACombatHandler:GetTrueRange(Unit)
    ...
    function SACombatHandler:GetTarget()
...
_G.class 'SAOrbwalker'

    SAOrbwalker.instance = 'Default'

    function SAOrbwalker:__init(Name)
        self.instance = Name
        self.enabled = true
        self.nextAttack = 0
        self.windUp = 0
        ...
        self.combatInstance = SACombatHandler(self.ts)
    ...
    function SAOrbwalker:__type()
        return 'SAOrbwalker'
    end

    function SAOrbwalker.Instance(Name)
        if SAOrbwalker.instance == '' then
            SAOrbwalker.instance = DefaultLoad(Name)
        end

        return SAOrbwalker.instance
    end

    function SAOrbwalker:OnTick()
    ...
    function SAOrbwalker:OnProcessSpell(unit, spell)
        if unit.isMe then
    ...
    function SAOrbwalker:OnSendPacket(packet)
        -- We could block attacks here
    end

    function SAOrbwalker:CheckThirdParty()
...
_G.class 'SAAuth'
    ...
    function SAAuth.Instance(Name)
        if self.instance == '' then
            self.instance = SAAuth(Name)
        end

        return self.instance
    end

    function SAAuth:IsAuthed()
        return self.Authed
    end

    function SAAuth:OnTick()
    ...
    function SAAuth:URL_Encode(String)
        if String then
        ...
        if self.NeedRun then
            ...
            GetAsyncWebResult(self.HOST, self.URL_PATH, function(Data)
                ...
                if OnlineVersion and self.LocalVersion and OnlineVersion > self.LocalVersion then
                    PrintChat("<font color='#CCCCCC'>[SA] SAUpdater: There is a new version of "..self.SCRIPT_NAME..". Don't F9 till done...</font>") 
        ...
        if self.NeedUpdate then
            ...
            DownloadFile(self.SCRIPT_URL, self.PATH, function()
                if FileExist(self.PATH) then
                    PrintChat("<font color='#CCCCCC'>[SA] SAUpdater: "..self.SCRIPT_NAME.." updated! Double F9 to use new version!</font>")
                end
            end)
        end
    end
...
function _G.CastOnObject(Spell, Object)
...
---------------------------- END OF LIB-----------------------------------------
local SAUpdate = SAUpdater("LibUpdate") 
local Version = 0.01
