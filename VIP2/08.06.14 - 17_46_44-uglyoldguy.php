...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 0.1
...
function Menu()
    ...
    Config.FarmSub:addParam("MinionLimit", "Min num minions for farm", SCRIPT_PARAM_SLICE, 2, 1, 5, 0)
    --KS
...
function AoEFarm()
  ...
  elseif QReady and not EReady and #EnemyMinions.objects > 1 and Pix ~= nil and #EnemyMinions.objects >= Config.FarmSub.MinionLimit then
    local NumHit1, FirstPosition1 = BestHitVector(myHero)
    local NumHit2, FirstPosition2 = BestHitVector(Pix)
    if NumHit1 == NumHit2 and FirstPosition1 ~= nil and FirstPosition1.x ~= nil then
      CastSpell(_Q, FirstPosition1.x, FirstPosition1.z)
    elseif NumHit1 > NumHit2 and FirstPosition1 ~= nil and FirstPosition1.x ~= nil then
      CastSpell(_Q, FirstPosition1.x, FirstPosition1.z)
    elseif NumHit1 < NumHit2 and FirstPosition2 ~= nil and FirstPosition2.x ~= nil then
      CastSpell(_Q, FirstPosition2.x, FirstPosition2.z)
    end
  elseif QReady and #EnemyMinions.objects < 2 and #EnemyMinions.objects >= Config.FarmSub.MinionLimit then
