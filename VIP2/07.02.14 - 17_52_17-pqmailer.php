<?php exit() ?>--by pqmailer 217.82.10.150
local Version = 0.1
local Config
local ts
local SpellData = {}
...
local DebuffTable = {}
local target
local QData = {last = 0, nextRelease = 0, haveToRelease = false, target = nil}
...
function OnSendPacket(p)
	if p.header == 0xE5 then
		...
		if sourceNetworkId == myHero.networkID and spellId == 128 and CountEnemyHeroInRange(SpellData.Q.Range + 100) > 0 then
			p:Block()
		end
	end
end
