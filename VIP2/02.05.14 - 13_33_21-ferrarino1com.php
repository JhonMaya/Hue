...
local function MenuExtraCombo()
    ...
    menu.combo.extracombo:addParam("autostartRnumber", "Auto (R) if enemys # >=", SCRIPT_PARAM_SLICE, 2, 1, 4, 0)
...
local function CastW(myTarget)
    ...
    if usew and wReady and ValidTarget(myTarget) then
        if GetDistance(myTarget) <= 285 then            
        	CastSpell(_W)            
        end
    end
...
function SidaMMA(myTarget)
	...
	if ComboON and Integration then
