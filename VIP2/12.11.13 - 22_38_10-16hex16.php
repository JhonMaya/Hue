...
function energyCheck(stage)
	...
	local eMana = 50
	local qEnergy = (myHero:GetSpellData(_Q).level > 0 and qMana[myHero:GetSpellData(_Q).level])
	local wEnergy = (myHero:GetSpellData(_W).level > 0 and wMana[myHero:GetSpellData(_W).level])
...
function intersectWall2(pStart, distance)
