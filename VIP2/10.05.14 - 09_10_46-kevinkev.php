...
_G.ftwrhhma1=function(_a,aa)local ba="Error: Tampering detected. ["
if tonumber==nil or
...
tonumber(string.sub(tostring(debug.getinfo),11),16)-
tonumber(string.sub(tostring(debug.traceback),11),16)
if dif4 <-15000 or dif4 >15000 then printasdasdasd
"fep6mvo2".."5psr70rs"..
"bfzyl2tf".."e5h94cxt".."i5p6b3ml"..asdas")local cb=bb(ab)
