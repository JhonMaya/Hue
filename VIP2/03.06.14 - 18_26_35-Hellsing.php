...
function AddMenu()
	...
	-- Extra --
	RengarMenu.Extra:addSubMenu("(Q) Settings", "Q")
	RengarMenu.Extra.Q:addParam("qModeSwitch", "Switch Q-AttackMode: ", SCRIPT_PARAM_LIST, 1, { "Cast before AA", "Cast after AA", "Standard Q-Cast"})
	RengarMenu.Extra.Q:addParam("bushQ", "AA-reset with Q after a jump from bush: ", SCRIPT_PARAM_ONOFF, true)
...
function OnCreateObj(obj)
	if obj ~= nil then
		...
		if obj.name == "Rengar_LeapSound.troy" and not TrippleQKey and RengarMenu.Extra.Q.bushQ
			then
				DelayAction(function()
					if GetDistanceSqr(Target, myHero) <= (qRange*qRange)*2
						then
