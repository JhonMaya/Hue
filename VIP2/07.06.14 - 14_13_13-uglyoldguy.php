...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 0.09
...
function Flee()
  ...
  if CloseEnemy ~= nil and CloseDistance < 1350 and ValidTarget(CloseEnemy, 1350) then
    CastQ(CloseEnemy)
  end
  if WReady then
    CastSpell(_W, myHero)
...
function AoEQ(Target)
  ...
  if QReady and not EReady and Pix ~= nil and GetDistance(Target) < SpellQ1.Range - 20 and CountEnemyHero(Target, SpellQ1.Range+25) == 0 and GetDistance(Pix) > 200 then
  ...
  elseif QReady and not EReady and Pix ~= nil and GetDistance(Target) < SpellQ1.Range - 20 and CountEnemyHero(Target, SpellQ1.Range+25) == 0 and GetDistance(Pix) < 200 then
    RegularQ(Target)
  ...
  elseif EReady and QReady and myHero.mana > myHero:GetSpellData(_Q).mana + myHero:GetSpellData(_E).mana and GetDistance(Target) < SpellQ2.Range + 25  and CountEnemyHero(Target, SpellQ1.Range+25) > 0 and Pix ~= nil then
    ...
    elseif BestSwitchLocation == nil then
      if CastPos3 ~= nil and Hit3 ~= nil then
        ...
        if CastPos2 ~= nil and Hit2 ~= nil and Hit2 >= Config.Extras.Hitchance and GetDistance(CastPos2) < SpellQ1.Range then
          CastSpell(_Q, CastPos2.x, CastPos2.z)
        elseif CastPos1 ~= nil and Hit1 ~= nil and Hit1 >= Config.Extras.Hitchance and GetDistance(CastPos1, Pix) < SpellQ1.Range and GetDistance(CastPos1) < SpellQ1.Range + GetDistance(Pix) + 100 and GetDistance(Pix) > 200 then
          CastSpell(_Q, CastPos1.x, CastPos1.z)
        end
        -- if Config.Extras.Debug then
  ...
  elseif Pix ~= nil and not EReady and QReady and GetDistance(Target) < SpellQ1.Range + GetDistance(Pix) + 100 and GetDistance(Pix) > 200  then
    -- if Config.Extras.Debug then
    ...
    if CastPos2 ~= nil and Hit2 ~= nil and Hit2 >= Config.Extras.Hitchance and GetDistance(CastPos2) < SpellQ1.Range then
      CastSpell(_Q, CastPos2.x, CastPos2.z)
    elseif CastPos1 ~= nil and Hit1 ~= nil and Hit1 >= Config.Extras.Hitchance and GetDistance(CastPos1) < SpellQ1.Range + GetDistance(Pix) + 100 and GetDistance(CastPos1, Pix) < SpellQ2.Range and GetDistance(Pix) > 200 then
      CastSpell(_Q, CastPos1.x, CastPos1.z)
    end
  elseif QReady then
    RegularQ(Target)
...
function ExtendedQ(Target)
  ...
  elseif Pix ~= nil and not EReady and QReady and GetDistance(Target) < SpellQ1.Range + GetDistance(Pix) + 100 then
    ...
    if CastPos2 ~= nil and Hit2 ~= nil and Hit2 >= Config.Extras.Hitchance and GetDistance(CastPos2) < SpellQ1.Range then
      CastSpell(_Q, CastPos2.x, CastPos2.z)
    elseif CastPos1 ~= nil and Hit1 ~= nil and Hit1 >= Config.Extras.Hitchance and GetDistance(CastPos1) < SpellQ1.Range + GetDistance(Pix) + 100 and GetDistance(CastPos1, Pix) < SpellQ1.Range and GetDistance(Pix) > 200 then
      CastSpell(_Q, CastPos1.x, CastPos1.z)
    end
  end
end
