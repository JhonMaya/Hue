...
local UPDATE_NAME = "Irelia by AWA"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/AWABoL150/BoL/blob/master/Irelia2.lua"..math.random(1, 1000)
local UPDATE_FILE_PATH = SCRIPT_PATH.."Irelia by AWA"
