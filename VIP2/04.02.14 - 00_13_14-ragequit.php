...
function Plugin:__init()
    ...
    SkillE = AutoCarry.Skills:NewSkill(false, _E, 425, "Defile", AutoCarry.SPELL_SELF, 0, false, false, 1.40, 250, 275, false)
...
function AntiESpam()
	for _, enemy in pairs(AutoCarry.Helper.EnemyTable) do
		if ValidTarget(enemy) and GetDistance(enemy) > 395 and HasEBuff == true then
			CastSpell(_E)
		end
	end
end		
...
function Plugin:OnCreateObj(Object)
	...
	if Object.name:find("Defile_green_cas.troy") then
		HasEBuff = true
	end
end	
...
if KarthConfig.DrawQ then
	AutoCarry.Helper:DrawCircleObject(myHero, 875, 0xFF0000, 3)
end	
if KarthConfig.DrawE then
	AutoCarry.Helper:DrawCircleObject(myHero, 425, 0xCC00FF, 3) 
end	
end	
...
KarthConfig:addParam("sep", "-- Drawing --", SCRIPT_PARAM_INFO, "")
KarthConfig:addParam("DrawQ", "Draw Q Range", SCRIPT_PARAM_ONOFF, true)
KarthConfig:addParam("DrawE", "Draw E Range", SCRIPT_PARAM_ONOFF, true)
end
