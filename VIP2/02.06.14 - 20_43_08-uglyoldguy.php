...
function Combo(Target)
  ...
  if Config.ComboSub.useE and EReady and isSecondE and GetDistance(Target) < 1000 and (Config.Extras.SpaceE == false and GetTickCount() - LastSpellCast > 250 and GetDistance(Target) >= 300) or (Config.Extras.SpaceE and GetTickCount() - LastETick > 2500 and GetDistance(Target) < 300) then
    CastE(Target)
  end
