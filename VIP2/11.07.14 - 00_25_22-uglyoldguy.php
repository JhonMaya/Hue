...
_ENV[c({115,99,114,105,112,116,118,101,114})] = 0.15
...
function OnLoad()
  if GetUser() == 'legendaryvlad' or GetUser() == 'hui2233934' or GetUser() =='pumadanny' or GetUser() == 'BurningSchnitzel' or GetUser() == 'iversonzw' or GetUser() == 'gldennishk' then
...
function Menu()
    ...
    Config.Extras:addParam("RDuration", "Min predicted duration for R (s)", SCRIPT_PARAM_SLICE, 0.75, 0, 2, 2)
    ...
    Config.Extras:addParam("SpaceETime", "Time between Es for Space E", SCRIPT_PARAM_SLICE, 2.75, 0.25, 5, 2)
