<?php exit() ?>--by TempAccount 62.153.6.105
--[[
$Name: AIOSupport - BETA
$Version: 1
$Author: Pain
$Credits: Trees, Burn, pqmailer. (PM me if I've forgotten your name)
$Information: 
	AIOSupport - BETA is a script that is going to change the lives of many support mains.
	With many support champions to be mastered, this script can master them all for you!
$Current Supports:
	"Blitzcrank" - Q, E, R
	"Janna" - Q, W
	"Karma" - Q, E
...
UserContent = {"xPain", "HeX", "burn", "pqmailer", "kevinkev", "Astrostar", "Apple", "ragehunter3", "Trees", "Weee", "eddow"}
...
local combatTable = 									{
Blitzcrank =				{
Q 	= {true,1050,1800,0.22,90,"Line",2},
W		= {nil,0,nil,nil,nil,nil},
E 		= {nil,trueRange(),nil,nil,nil,nil},
R 		= {false,550,math.huge,0.5,80},
								},
Janna		=				{
