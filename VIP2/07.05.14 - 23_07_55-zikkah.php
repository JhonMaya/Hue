	...
	if MMenu.aSpear then
		...
		if bestTarget and myHero.mana >= qManaHuman then
			...
			elseif bestTarget.hp < 0 then
				if GetDistance(bestTarget.pos) > 400 then
					CastSpell(_R)
				end
			end
		end
...
function OnDraw()
	    ...
	    DrawText("QH:"..tostring(Qh.state),50,100 ,100 ,ARGB(255,0,255,0))   
	    DrawText("WH:"..tostring(Wh.state),50,100 ,140 ,ARGB(255,0,255,0))   
	    DrawText("EH:"..tostring(Eh.state),50,100 ,180 ,ARGB(255,0,255,0))   
	    DrawText("QC:"..tostring(Qc.state),50,500 ,100 ,ARGB(255,0,255,0))   
	    DrawText("WC:"..tostring(Wc.state),50,500 ,140 ,ARGB(255,0,255,0))   
	    DrawText("EC:"..tostring(Ec.state),50,500 ,180 ,ARGB(255,0,255,0))   
