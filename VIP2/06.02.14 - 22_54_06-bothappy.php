...
local Config, rStacks, localVersion, heroTable, enemyTable, allyTable, towerFocusTable, lockedTarget, targetGlobal, targetExpected, IgniteSlot, lastAttack = nil, 0, 0.02, GetHeroTable(1), GetHeroTable(2), GetHeroTable(3), {}, nil, nil, nil, nil, os.clock()
local immuneEffects = {
