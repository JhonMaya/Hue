...
function OnLoad()
	...
	Config.extra:addParam("aimQmouse", "Aim to nearest mouse target", SCRIPT_PARAM_ONKEYDOWN, false, GetKey("Q"))
...
function OnTick()
	...
	if Config.extra.aimQmouse then _AimQToEnemy(mousePos) end
	_ResetSettings()
