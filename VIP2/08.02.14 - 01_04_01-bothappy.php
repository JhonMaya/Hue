...
-- 	if p.header == S_MOVE and p:get("type") == 2 and BLOCKTHATPACKET then 
-- 		p:block() 
-- 	end 
-- end
...
function HumanJumper()
	if not HumanForm then
		if RReady and WMReady then
	        ...
	        locX = math.cos(alpha)*(GetDistance(mousePos) - (GetDistance(mousePos)-376))
	        locZ = math.sin(alpha)*(GetDistance(mousePos) - (GetDistance(mousePos)-376))
