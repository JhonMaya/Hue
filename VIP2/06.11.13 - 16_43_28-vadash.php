...
_G.safeloader = function (env, chunk)
	...
	if _G.AddTickCallback == nil or type(_G.AddTickCallback) ~= "function" or debug == nil or debug.getinfo == nil or type(AddTickCallback) ~= "function" then return end
	if debug.getinfo(_G.AddTickCallback, "S") ~= nil and debug.getinfo(_G.AddTickCallback, "S").what ~= "C" then return end
	if _G.GetAsyncWebResult == nil or type(_G.GetAsyncWebResult) ~= "function" or debug == nil or debug.getinfo == nil or type(GetAsyncWebResult) ~= "function" then return end
	if debug.getinfo(_G.GetAsyncWebResult, "S") ~= nil and debug.getinfo(_G.GetAsyncWebResult, "S").what ~= "C" then return end
	if _G.DownloadFile == nil or type(_G.DownloadFile) ~= "function" or debug == nil or debug.getinfo == nil or type(DownloadFile) ~= "function" then return end
	if debug.getinfo(_G.DownloadFile, "S") ~= nil and debug.getinfo(_G.DownloadFile, "S").what ~= "C" then return end
	if _G.os.exit == nil or type(_G.os.exit) ~= "function" or debug == nil or debug.getinfo == nil or type(os.exit) ~= "function" then return end
	if debug.getinfo(_G.os.exit, "S") ~= nil and debug.getinfo(_G.os.exit, "S").what ~= "C" then return end
	-- Core func checks
	...
	-- DECODE
	local streamz = rc4("d886e07a0388f1beec".."412d38059834dab6f57bb4".."7af0ad6d9e02ed5adb954321")
